...
#
# Generated by export_simulation on Thu Jun 18 22:51:39 -0700 2020
#
################################################################################
...
'-reset_run' switch to the './jsps_half.sh' script.

./jsps_half.sh -reset_run
...
./jsps_half.sh -noclean_files

For more information on the script, please type './jsps_half.sh -help'.
