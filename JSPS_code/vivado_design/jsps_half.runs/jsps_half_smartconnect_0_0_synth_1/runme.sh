...
HD_PWD='C:/Users/vpanchbhaiyye/Documents/jsps_half/jsps_half.runs/jsps_half_smartconnect_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log jsps_half_smartconnect_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source jsps_half_smartconnect_0_0.tcl
